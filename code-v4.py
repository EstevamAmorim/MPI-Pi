...
if rank == 0:
    # print('Processes computed Pi value (N={0}, Iterations={1}) in {2:.2f}ms: {3}'.format(n, ITERATIONS, avgDeltaTimeMs, total[0]))
    print('Processes computed Pi value (N={0}, Iterations={1}) in {2:.2f}ms: {3}'.format(n, ITERATIONS, avgTimePerCompMs, total[0]))